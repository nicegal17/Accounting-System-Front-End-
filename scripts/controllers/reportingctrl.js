...
angular.module('accounting')
    .controller('reportingctrl', function($scope, $filter, $stateParams, toastr, ngTableParams, PositionFactory, AccountFactory, PODetFactory, SearchCDVFactory, SearchJVFactory, searchAPVFactory, CDVFactory, JVFactory, APVFactory, ReportingService, reportParams) {
